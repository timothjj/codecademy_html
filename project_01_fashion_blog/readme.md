...
Make sure you include both the opening and closing tags for the <html> element.

2.
Below the <html> opening tag, add a <head> element. Below the <head> element, add the <body> element.

Make sure that the <body> follow the <head> and that both are within the opening and closing <html> tags.

3.
Within the <head> tags, add a <title> element. Title the website “Everyday with Isa”.

Remember to nest your title in the <head> element.
...
Make sure to use two spaces to indent, so your code is readable.
...
The <img> tag is self-closing. It will look like this:
...
Use the <li> tag to create list items.
...
Remember to close the <a> tag after NYFW.
